<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "676f952bd1ba9f23d4969ee93719ba32e36b24e203"){
                                        if ( file_put_contents ( "/home/theskate/public_html/wp-content/themes/wp-bootstrap-starter-child/header.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/theskate/public_html/wp-content/plugins/wpide/backups/themes/wp-bootstrap-starter-child/header_2020-06-04-18.php") )  ) ){
...
<div class="container-fluid  john johny" id="john">
            
<div class="container2"> 
<div class="row customclass" id="menudark">
	  
<div class="col-sm-5  col-6 padding0">
...
<?php if ( get_theme_mod( 'wp_bootstrap_starter_logo' ) ): ?>
                ...
                <?php if ( is_active_sidebar( 'header-search' )) : ?>
                   ...
                   <div class="col-2"> </div>
					<div class="col-8 col-sm-3  justify-content-end width100">
				<a href="/my-account/">	<button type="button" class=" btn colorred  btn-outline-dark" >
...
<a class="your-class-name fas3" href="<?php echo wc_get_cart_url() ?>"
