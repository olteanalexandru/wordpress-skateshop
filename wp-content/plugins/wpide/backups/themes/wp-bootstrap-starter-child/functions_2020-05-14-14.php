<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "532698aa106f8a74336da8f25b6e28cacdd0234948"){
                                        if ( file_put_contents ( "/home/theskate/public_html/wp-content/themes/wp-bootstrap-starter-child/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/theskate/public_html/wp-content/plugins/wpide/backups/themes/wp-bootstrap-starter-child/functions_2020-05-14-14.php") )  ) ){
...
var currentScrollPos = window.pageYOffset;
  if (prevScrollpos > currentScrollPos) {
    ...
    document.getElementById("john").style.top = "-150px";
  }
