<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "532698aa106f8a74336da8f25b6e28cae96fb2d03d"){
                                        if ( file_put_contents ( "/home/theskate/public_html/wp-content/themes/wp-bootstrap-starter-child/header.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/theskate/public_html/wp-content/plugins/wpide/backups/themes/wp-bootstrap-starter-child/header_2020-01-28-15.php") )  ) ){
	...
	<div class="row">
		...
		<div class="col-md-4">
			...
			<div class="col-md-4">
				...
				<div class="col-md-4">
<a href="https://theskate420.com/basket/">
					<button type="button" class="  btn btn-outline-danger  btn-md" >
