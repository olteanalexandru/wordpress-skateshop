<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "1aeb746ace7e8df1ffcd9eefbe99fc71ac5c4e14be"){
                                        if ( file_put_contents ( "/home/theskate/public_html/wp-content/themes/wp-bootstrap-starter-child/header.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/theskate/public_html/wp-content/plugins/wpide/backups/themes/wp-bootstrap-starter-child/header_2020-05-20-08.php") )  ) ){
...
<?php if ( get_theme_mod( 'wp_bootstrap_starter_logo' ) ): ?>
                ...
                <?php if ( is_active_sidebar( 'header-search' )) : ?>
					...
					<div class="col-8  justify-content-end width100">
...
<a href="/basket/">
				...
				<p class="clasabtn2"> <i class="fas fa-shopping-basket"> </i>  <?php global $woocommerce; ?>
